...
We take reasonable measures to protect data during transmission. All communication between our application and third-party APIs, including the TikTok API, is performed over HTTPS/TLS encrypted connections. Because we do not store your TikTok data on any server after the report is generated, the risk of a data breach is minimal.
...
You may revoke access to your TikTok account at any time by visiting **TikTok Settings → Security → Authorized Apps
